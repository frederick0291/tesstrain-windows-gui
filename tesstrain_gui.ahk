	...
	CreateGui()	{
		...
		AddFolderSelection(
			...
			"Data directory for output files, proto model, start model, etc.`n"
				. "It will be created if doesn't exist.`n`n"
		...
		AddEditBox(
			...
			"Default network specification: [1,36,0,1 Ct3,3,16 Mp3,3 Lfys48 Lfx96 Lrx96 Lfx192 O1c###].`n"
				. "'c###' will be automatically replaced with 'c<unichars_size>', where <unichars_size> value is generated by 'unicharset_extractor' and saved in the first line of its generated 'unicharset' output file.",
